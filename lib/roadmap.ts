...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    effort: "L",
    description:
      "Schedule techs to jobs. Drag-drop calendar. Drying-day check-ins auto-scheduled. Conflicts flagged.",
  },
  {
    id: "documents",
    ...
    effort: "L",
    description:
      "Per-job doc vault: signed AOBs, insurance docs, COIs, certificates, before/during/after photo galleries. Tagged + searchable.",
  },
  {
    id: "email-sms",
    ...
    effort: "M",
    description:
      "Branded email templates via Resend. SMS via Twilio. Customer-facing 'we're on the way,' 'tech arrived,' 'drying complete.'",
  },
  {
    id: "reporting",
    title: "Reporting",
    ...
    effort: "L",
    description:
      "Jobs by source, lead-to-bill cycle time, conversion rates, margin per zip code, partner referral leaderboard. CSV exports.",
  },
  {
    id: "customer-portal",
    ...
    effort: "L",
    description:
      "Homeowners log in to see job status, upload more photos, sign documents, view invoices. Reduces support calls.",
  },
  {
    id: "adjuster-portal",
