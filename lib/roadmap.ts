...
export const ROADMAP: RoadmapItem[] = [
  ...
  {
    id: "job-economics",
    title: "Job Economics Dashboard",
    track: "core",
    status: "done",
    effort: "L",
    shipped_at: "2026-04-30",
    description:
      "/reports/job-economics — per-job revenue, cycle time, equipment utilization. Headline KPIs (avg revenue/job, days on job, days to collect, equipment days), insight cards (slowest equipment stays, most efficient $/equip-day), and a 50-job table sorted by revenue. Honest caveat: not true margin until labor + consumables ship.",
    features: [
      "Per-job revenue (billed + collected) and open balance",
      "Days-on-job (intake → completion) and days-to-collect (sent → fully paid)",
      "Equipment-days computed from equipment_assignments",
      "$/equip-day efficiency proxy",
      "Top 3 longest equipment stays + top 3 most efficient jobs",
      "Linked from /reports header",
    ],
  },
  {
