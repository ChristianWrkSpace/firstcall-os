    ...
    <div className={cn("flex flex-col h-full", className)}>
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-2 space-y-6">
        {sections.map((section, si) => (
          <div key={si}>
            <p className="px-3 mb-1.5 text-[9px] font-medium tracking-[0.2em] uppercase text-[color:var(--color-text-muted)]">
              {section.title}
            </p>
                  ...
                  <li key={ii}>
                    <a
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-[color:var(--color-surface-strong)] text-[color:var(--color-text-primary)]"
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.span
                          layoutId="nav-active"
                          className="w-1.5 h-1.5 rounded-full bg-[#5FBDB0]"
