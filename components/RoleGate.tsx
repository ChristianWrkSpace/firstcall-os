...
export function NoAccessPanel({
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl">
      <div className="bg-card border border-edge2 rounded-xl p-8">
        <h1 className="text-xl font-bold text-ink">Access restricted</h1>
        <p className="text-ink-2 text-sm mt-2 leading-relaxed">
          This page is for{" "}
          <span className="text-ink">{needs.join(" / ")}</span> only. You're
          signed in as <span className="text-ink capitalize">{role}</span>.
