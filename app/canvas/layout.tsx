...
export default async function CanvasLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--color-bg-deep)" }}>
      <header className="relative z-30 shrink-0 flex items-center justify-between px-6 py-3" style={{ borderBottom: "1px solid var(--color-edge)", backgroundColor: "rgba(250,246,239,0.92)" }}>
