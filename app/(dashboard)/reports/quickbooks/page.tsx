  ...
  if (me.role !== "owner" && me.role !== "manager") {
    return (
      <div className="p-8 max-w-2xl">
        <h1 className="text-2xl font-bold text-ink">QuickBooks Export</h1>
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl">
      ...
      <section className="glass-card p-6">
        <h2 className="text-ink font-semibold mb-3">How to import in QBO</h2>
        <ol className="flex flex-col gap-3 text-sm text-ink-2 list-decimal list-inside">
          <li>
            <strong className="text-ink">Customers first.</strong> QBO needs
            customer records before invoices can reference them. Open QBO →
            Customers → New customer → "Import multiple". Upload the customers
            CSV from this page.
          </li>
          <li>
            <strong className="text-ink">Then invoices.</strong> QBO → Sales
            → Invoices → New invoice dropdown → "Import invoices". Map columns
            if prompted; defaults usually work.
          </li>
          <li>
            <strong className="text-ink">Payments last.</strong> QBO →
